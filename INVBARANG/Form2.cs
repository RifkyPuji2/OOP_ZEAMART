...
namespace INVBARANG
{
    public partial class Form2 : Form
    {
        ...
        private void Tampil(string valueToSearch)
        {
            ...
            dataGridView1.Columns[4].HeaderText = "Kondisi";
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            //command.Parameters.Add("@tglmsk", MySqlDbType.VarChar).Value = textBox3.Text;
        ...
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            NB.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
            KTG.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
            H.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
            TK.Text = dataGridView1.CurrentRow.Cells[4].Value.ToString();
